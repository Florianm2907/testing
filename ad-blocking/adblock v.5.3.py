...
print("Läuft!")
toast = ToastNotifier()
toast.show_toast("Adblocker läuft!", "Spotify Adblocker Version 5.3", duration=5, icon_path="./info.ico")
...
def audio():
    ...
    for session in sessions:
        ...
        if session.Process and session.Process.name() == "adblockv.5.3.exe":
